...
// encoded input text. A greater portion of the visible window is dedicated to
...
// rely on the copy to clipboard button to retrieve encoded text.
//
...
func NewOutputTextField() *widget.Entry {
	...
	outputField.PlaceHolder = encodedOutputPlaceholder
...
func NewOutputTextLabel() *widget.Label {
	outputLabel := widget.NewLabel(encodedOutputPlaceholder)
